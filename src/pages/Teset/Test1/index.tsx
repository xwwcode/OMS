...
const ACTIONS = {
  FETCH_LIST: 'tesetAndTest1/fetchList',
  FETCH_ITEM: 'tesetAndTest1/fetchItem',
  ADD_ITEM: 'tesetAndTest1/addItem',
  UPDATE_ITEM: 'tesetAndTest1/updateItem',
  DELETE_ITEM: 'tesetAndTest1/deleteItem',
  SWITCH_STATUS: 'tesetAndTest1/switchStatus',
};
...
export default connect(({ tesetAndTest1, loading }: ConnectPageState) => ({
  dataScouce: tesetAndTest1.list,
  searchData: tesetAndTest1.searchData,
