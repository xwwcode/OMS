...
export type ConnectPageState = ConnectState & { childTheUserPage: PartialStateType };
...
const Model: ModelType = {
  ...
  effects: {
    *fetchList({ payload }, { call, put }) {
      const res = yield call(userList.isApi, payload);
      yield put({
        type: 'saveList',
    ...
    //   const res = yield call(userList.byId, payload);
    ...
    *updateItem({ payload }, { call }) {
    ...
    //   const res = yield call(userList.destroy, payload);
    //   return !!res;
    // },

    // *switchStatus({ payload }, { call, put }) {
    //   const { enabled, id } = payload;
    //   const res = yield call(enabled ? userList.disable : userList.enable, id);
